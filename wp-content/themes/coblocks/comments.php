	...
	<div class="comments__inner container">
		...
		if ( have_comments() ) :
			...
			the_comments_pagination(
				array(
					'prev_text' => wp_kses( coblocks_get_svg( array( 'icon' => 'left' ) ), coblocks_svg_allowed_html() ) . '<span class="screen-reader-text">' . __( 'Previous', 'coblocks' ) . '</span>',
					'next_text' => '<span class="screen-reader-text">' . __( 'Next', 'coblocks' ) . '</span>' . wp_kses( coblocks_get_svg( array( 'icon' => 'right' ) ), coblocks_svg_allowed_html() ),
				)
			);
